...
5. The key value pair of the object graph must be separated by a colon.
6. Each key value pair set of the object graph must be separated by the newline character.
